...
// Social icons component for reusability
...
const DesktopSidebar = memo(({ activeSection, searchValue, handleSearch, navItems, handleNavClick }: DesktopSidebarProps) => (
  <motion.div 
...
const MobileNavbar = memo(({ activeSection, navItems, handleNavClick }: MobileNavbarProps) => (
  <motion.div 
...
export default function Sidebar() {
  ...
  // Handle section detection through intersection observer
  useEffect(() => {

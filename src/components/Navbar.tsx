...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 py-4 glass-effect border-b border-zinc-800/50">
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link href="#home" className="text-zinc-400 hover:text-white text-sm transition-colors">
            Home
          </Link>
        ...
        <Button 
          variant="ghost" 
          className="md:hidden text-zinc-200 hover:bg-zinc-800/50"
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="flex flex-col space-y-4 px-4">
              <Link 
                href="#home" 
                className="text-zinc-400 hover:text-white py-2 text-sm transition-colors"
